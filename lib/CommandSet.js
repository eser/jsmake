...
const esm_2 = require("es6-eventemitter/lib/esm");
const esm_3 = require("ponyfills/lib/esm");
...
class CommandSet {
    constructor() {
        this.events = new esm_2.EventEmitter();
        this.taskRules = {
            label: 'jsmake',
            strict: true,
            children: {}
    ...
    addCommand(pathstr, command) {
        ...
        targetNode.parent[targetNode.name] = esm_3.assign({}, targetNode.instance, {
            type: esm_1.Consultant.types.command,
            aliases: [],
            id: pathstr,
            uiHidden: false,
