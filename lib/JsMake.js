...
class JsMake {
    ...
    loadPlugins() {
        _maester2.default.debug('loading plugins...');
    ...
    menu() {
        ...
        return _asyncToGenerator(function* () {
            ...
            for (const taskKey of Object.keys(_this2.tasks)) {
                const task = _this2.tasks[taskKey];
            ...
            const result = yield taskPage.inquiry();

            if (result instanceof Object) {
                yield _this2.exec(result.argv);
