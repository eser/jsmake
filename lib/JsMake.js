...
const esm_2 = require("maester/lib/esm");
const esm_3 = require("senior/lib/esm");
const esm_4 = require("ponyfills/lib/esm");
...
class JsMake extends CommandSet_1.CommandSet {
    constructor() {
        ...
        this.logger = new esm_2.Maester();
        this.plugins = new esm_3.Senior('jsmake');
    ...
    task(pathstr, ...params) {
        ...
        if (lastParam.constructor !== Function && lastParam instanceof Object) {
            options = esm_4.assign({}, lastParam);
            paramCount--;
        }
        else {
            options = {};
