...
const argValues = argvPage.validate(_consultant2.default.parse(process.argv.slice(2)));

const argv = argValues.argv;

const logger = _maester2.default.addLogger('ConsoleLogger', argv.verbosity);
...
if (argv.version) {
    ...
    } else if (argv.taskmenu || argv._.length === 0 && _2.default.tasks.default === undefined) {
